...
import com.example.bienestarproveedores.data.LoginRepository;
import com.example.bienestarproveedores.data.Result;
...
public class LoginViewModel extends ViewModel {
    ...
    public void login(String username, String password) {
        ...
        if (result instanceof Result.Success) {
            ...
            loginResult.setValue(new LoginResult(LoginDataSource.getProvider(username)));
        } else {
